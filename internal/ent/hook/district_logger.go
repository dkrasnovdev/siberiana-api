...
// DistrictLogger is a hook that logs changes to an District entity.
func DistrictLogger(client *ent.Client) ent.Hook {
	// Register the DistrictFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.DistrictFunc(func(ctx context.Context, m *ent.DistrictMutation) (ent.Value, error) {
