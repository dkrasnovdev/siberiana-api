...
// OrganizationLogger is a hook that logs changes to an Organization entity.
func OrganizationLogger(client *ent.Client) ent.Hook {
	// Register the OrganizationFunc hook.
