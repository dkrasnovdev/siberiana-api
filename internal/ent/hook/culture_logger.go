...
// CultureLogger is a hook that logs changes to an Culture entity.
func CultureLogger(client *ent.Client) ent.Hook {
	// Register the CultureFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.CultureFunc(func(ctx context.Context, m *ent.CultureMutation) (ent.Value, error) {
