...
// MonumentLogger is a hook that logs changes to an Monument entity.
func MonumentLogger(client *ent.Client) ent.Hook {
	// Register the MonumentFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.MonumentFunc(func(ctx context.Context, m *ent.MonumentMutation) (ent.Value, error) {
