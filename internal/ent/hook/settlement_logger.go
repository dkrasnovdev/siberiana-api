...
// SettlementLogger is a hook that logs changes to an Settlement entity.
func SettlementLogger(client *ent.Client) ent.Hook {
	// Register the SettlementFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.SettlementFunc(func(ctx context.Context, m *ent.SettlementMutation) (ent.Value, error) {
			var blame string
