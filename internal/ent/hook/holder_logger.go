...
// HolderLogger is a hook that logs changes to an Holder entity.
func HolderLogger(client *ent.Client) ent.Hook {
	// Register the HolderFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.HolderFunc(func(ctx context.Context, m *ent.HolderMutation) (ent.Value, error) {
