...
// PersonLogger is a hook that logs changes to an Person entity.
func PersonLogger(client *ent.Client) ent.Hook {
	// Register the PersonFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.PersonFunc(func(ctx context.Context, m *ent.PersonMutation) (ent.Value, error) {
