...
// TechniqueLogger is a hook that logs changes to an Technique entity.
func TechniqueLogger(client *ent.Client) ent.Hook {
	// Register the TechniqueFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.TechniqueFunc(func(ctx context.Context, m *ent.TechniqueMutation) (ent.Value, error) {
			var blame string
