...
// CollectionLogger is a hook that logs changes to an Collection entity.
func CollectionLogger(client *ent.Client) ent.Hook {
	// Register the CollectionFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.CollectionFunc(func(ctx context.Context, m *ent.CollectionMutation) (ent.Value, error) {
