...
// RegionLogger is a hook that logs changes to an Region entity.
func RegionLogger(client *ent.Client) ent.Hook {
	// Register the RegionFunc hook.
	return hook.On(func(next ent.Mutator) ent.Mutator {
		return hook.RegionFunc(func(ctx context.Context, m *ent.RegionMutation) (ent.Value, error) {
