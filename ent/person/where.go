...
func ExternalLinksIsNil() predicate.Person {
	return predicate.Person(sql.FieldIsNull(FieldExternalLinks))
}

// ExternalLinksNotNil applies the NotNil predicate on the "external_links" field.
func ExternalLinksNotNil() predicate.Person {
	return predicate.Person(sql.FieldNotNull(FieldExternalLinks))
}
