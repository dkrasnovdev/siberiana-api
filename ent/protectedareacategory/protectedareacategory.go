...
const (
	// Label holds the string label denoting the protectedareacategory type in the database.
	Label = "protected_area_category"
...
// OrderOption defines the ordering options for the ProtectedAreaCategory queries.
