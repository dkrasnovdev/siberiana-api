...
func ExternalLinksIsNil() predicate.Category {
	return predicate.Category(sql.FieldIsNull(FieldExternalLinks))
}

// ExternalLinksNotNil applies the NotNil predicate on the "external_links" field.
func ExternalLinksNotNil() predicate.Category {
	return predicate.Category(sql.FieldNotNull(FieldExternalLinks))
}
