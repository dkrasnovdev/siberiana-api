...
func (*ArtGenre) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case artgenre.FieldCreatedBy, artgenre.FieldUpdatedBy, artgenre.FieldDisplayName, artgenre.FieldAbbreviation, artgenre.FieldDescription, artgenre.FieldExternalLink, artgenre.FieldSlug:
