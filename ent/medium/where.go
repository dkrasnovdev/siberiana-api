...
func HasArtsWith(preds ...predicate.Art) predicate.Medium {
	return predicate.Medium(func(s *sql.Selector) {
		step := newArtsStep()
...
func And(predicates ...predicate.Medium) predicate.Medium {
	return predicate.Medium(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.Medium) predicate.Medium {
	return predicate.Medium(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.Medium) predicate.Medium {
	return predicate.Medium(sql.NotPredicates(p))
}
