...
func ExternalLinksIsNil() predicate.Medium {
	return predicate.Medium(sql.FieldIsNull(FieldExternalLinks))
}

// ExternalLinksNotNil applies the NotNil predicate on the "external_links" field.
func ExternalLinksNotNil() predicate.Medium {
	return predicate.Medium(sql.FieldNotNull(FieldExternalLinks))
}
