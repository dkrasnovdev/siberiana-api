...
const (
	// Label holds the string label denoting the familia type in the database.
	Label = "familia"
	...
	// Table holds the table name of the familia in the database.
	Table = "familia"
	...
	HerbariaColumn = "familia_herbaria"
)

// Columns holds all SQL columns for familia fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the Familia queries.
