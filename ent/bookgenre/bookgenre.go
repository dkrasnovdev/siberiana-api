...
const (
	// Label holds the string label denoting the bookgenre type in the database.
	Label = "book_genre"
...
var (
	...
	BooksPrimaryKey = []string{"book_genre_id", "book_id"}
)
...
// OrderOption defines the ordering options for the BookGenre queries.
