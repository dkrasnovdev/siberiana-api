...
func HasArt() predicate.District {
...
func HasArtWith(preds ...predicate.Art) predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := newArtStep()
...
func HasArtifacts() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasArtifactsWith(preds ...predicate.Artifact) predicate.District {
	return predicate.District(func(s *sql.Selector) {
...
func HasBooks() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBooksWith(preds ...predicate.Book) predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := newBooksStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasHerbaria() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasHerbariaWith(preds ...predicate.Herbarium) predicate.District {
	return predicate.District(func(s *sql.Selector) {
...
func HasProtectedAreaPictures() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProtectedAreaPicturesWith(preds ...predicate.ProtectedAreaPicture) predicate.District {
	return predicate.District(func(s *sql.Selector) {
...
func HasKnownAsAfter() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasKnownAsAfterWith(preds ...predicate.District) predicate.District {
	return predicate.District(func(s *sql.Selector) {
...
func HasKnownAsBefore() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasKnownAsBeforeWith(preds ...predicate.District) predicate.District {
	return predicate.District(func(s *sql.Selector) {
