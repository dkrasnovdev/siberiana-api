...
var (
	...
	KnownAsAfterPrimaryKey = []string{"district_id", "known_as_after_id"}
	...
	KnownAsBeforePrimaryKey = []string{"district_id", "known_as_after_id"}
)
