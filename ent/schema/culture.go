...
// Privacy policy of the Culture.
func (Culture) Policy() ent.Policy {
...
// Mixin of the Culture.
func (Culture) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixin.AuditMixin{},
		mixin.DetailsMixin{},
	}
...
// Annotations of the Culture.
func (Culture) Annotations() []schema.Annotation {
