...
// Privacy policy of the Publication.
func (Publication) Policy() ent.Policy {
...
// Mixin of the Publication.
func (Publication) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixin.AuditMixin{},
		mixin.DetailsMixin{},
	}
...
// Annotations of the Publication.
