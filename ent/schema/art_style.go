...
// Privacy policy of the ArtStyle.
func (ArtStyle) Policy() ent.Policy {
...
// Mixin of the ArtStyle.
func (ArtStyle) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixin.AuditMixin{},
		mixin.DetailsMixin{},
	}
...
// Annotations of the ArtStyle.
func (ArtStyle) Annotations() []schema.Annotation {
