...
const (
	// Label holds the string label denoting the periodical type in the database.
	Label = "periodical"
	...
	EdgeBooks = "books"
	// Table holds the table name of the periodical in the database.
	Table = "periodicals"
	...
	BooksColumn = "periodical_books"
)

// Columns holds all SQL columns for periodical fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the Periodical queries.
