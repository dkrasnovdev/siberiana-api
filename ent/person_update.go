...
func (pu *PersonUpdate) AddHerbariumIDs(ids ...int) *PersonUpdate {
	pu.mutation.AddHerbariumIDs(ids...)
	return pu
}

// AddHerbaria adds the "herbaria" edges to the Herbarium entity.
func (pu *PersonUpdate) AddHerbaria(h ...*Herbarium) *PersonUpdate {
	ids := make([]int, len(h))
	for i := range h {
		ids[i] = h[i].ID
	}
	return pu.AddHerbariumIDs(ids...)
}
...
func (pu *PersonUpdate) ClearHerbaria() *PersonUpdate {
	pu.mutation.ClearHerbaria()
	return pu
}

// RemoveHerbariumIDs removes the "herbaria" edge to Herbarium entities by IDs.
func (pu *PersonUpdate) RemoveHerbariumIDs(ids ...int) *PersonUpdate {
	pu.mutation.RemoveHerbariumIDs(ids...)
	return pu
}

// RemoveHerbaria removes "herbaria" edges to Herbarium entities.
func (pu *PersonUpdate) RemoveHerbaria(h ...*Herbarium) *PersonUpdate {
	ids := make([]int, len(h))
	for i := range h {
		ids[i] = h[i].ID
	}
	return pu.RemoveHerbariumIDs(ids...)
}
...
func (pu *PersonUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.HerbariaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   person.HerbariaTable,
			Columns: []string{person.HerbariaColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := pu.mutation.RemovedHerbariaIDs(); len(nodes) > 0 && !pu.mutation.HerbariaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   person.HerbariaTable,
	...
	if nodes := pu.mutation.HerbariaIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   person.HerbariaTable,
...
// AddHerbariumIDs adds the "herbaria" edge to the Herbarium entity by IDs.
func (puo *PersonUpdateOne) AddHerbariumIDs(ids ...int) *PersonUpdateOne {
	puo.mutation.AddHerbariumIDs(ids...)
	return puo
}

// AddHerbaria adds the "herbaria" edges to the Herbarium entity.
func (puo *PersonUpdateOne) AddHerbaria(h ...*Herbarium) *PersonUpdateOne {
	ids := make([]int, len(h))
	for i := range h {
		ids[i] = h[i].ID
	}
	return puo.AddHerbariumIDs(ids...)
}
...
// ClearHerbaria clears all "herbaria" edges to the Herbarium entity.
func (puo *PersonUpdateOne) ClearHerbaria() *PersonUpdateOne {
	puo.mutation.ClearHerbaria()
	return puo
}

// RemoveHerbariumIDs removes the "herbaria" edge to Herbarium entities by IDs.
func (puo *PersonUpdateOne) RemoveHerbariumIDs(ids ...int) *PersonUpdateOne {
	puo.mutation.RemoveHerbariumIDs(ids...)
	return puo
}

// RemoveHerbaria removes "herbaria" edges to Herbarium entities.
func (puo *PersonUpdateOne) RemoveHerbaria(h ...*Herbarium) *PersonUpdateOne {
	ids := make([]int, len(h))
	for i := range h {
		ids[i] = h[i].ID
	}
	return puo.RemoveHerbariumIDs(ids...)
}
...
func (puo *PersonUpdateOne) sqlSave(ctx context.Context) (_node *Person, err error) {
	...
	if puo.mutation.HerbariaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   person.HerbariaTable,
	...
	if nodes := puo.mutation.RemovedHerbariaIDs(); len(nodes) > 0 && !puo.mutation.HerbariaCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   person.HerbariaTable,
	...
	if nodes := puo.mutation.HerbariaIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   person.HerbariaTable,
