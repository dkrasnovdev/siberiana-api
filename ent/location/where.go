...
func SlugIsNil() predicate.Location {
	return predicate.Location(sql.FieldIsNull(FieldSlug))
}

// SlugNotNil applies the NotNil predicate on the "slug" field.
func SlugNotNil() predicate.Location {
	return predicate.Location(sql.FieldNotNull(FieldSlug))
}
