...
const (
	// Label holds the string label denoting the culture type in the database.
	Label = "culture"
	...
	// Table holds the table name of the culture in the database.
	Table = "cultures"
	...
	ArtifactsColumn = "culture_artifacts"
	...
	PetroglyphsColumn = "culture_petroglyphs"
)

// Columns holds all SQL columns for culture fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the Culture queries.
