...
func ExternalLinksIsNil() predicate.Model {
	return predicate.Model(sql.FieldIsNull(FieldExternalLinks))
}

// ExternalLinksNotNil applies the NotNil predicate on the "external_links" field.
func ExternalLinksNotNil() predicate.Model {
	return predicate.Model(sql.FieldNotNull(FieldExternalLinks))
}
