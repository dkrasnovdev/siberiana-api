...
const (
	// Label holds the string label denoting the genus type in the database.
	Label = "genus"
	...
	// Table holds the table name of the genus in the database.
	Table = "genus"
	...
	HerbariaColumn = "genus_herbaria"
)

// Columns holds all SQL columns for genus fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the Genus queries.
