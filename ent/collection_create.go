...
func (cc *CollectionCreate) SetDeletedBy(s string) *CollectionCreate {
	cc.mutation.SetDeletedBy(s)
	return cc
}

// SetNillableDeletedBy sets the "deleted_by" field if the given value is not nil.
func (cc *CollectionCreate) SetNillableDeletedBy(s *string) *CollectionCreate {
	if s != nil {
		cc.SetDeletedBy(*s)
	}
	return cc
...
func (cc *CollectionCreate) AddDendrochronologyIDs(ids ...int) *CollectionCreate {
	cc.mutation.AddDendrochronologyIDs(ids...)
	return cc
}

// AddDendrochronology adds the "dendrochronology" edges to the Dendrochronology entity.
func (cc *CollectionCreate) AddDendrochronology(d ...*Dendrochronology) *CollectionCreate {
	ids := make([]int, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return cc.AddDendrochronologyIDs(ids...)
}
...
func (cc *CollectionCreate) AddHerbariumIDs(ids ...int) *CollectionCreate {
	cc.mutation.AddHerbariumIDs(ids...)
	return cc
}

// AddHerbaria adds the "herbaria" edges to the Herbarium entity.
func (cc *CollectionCreate) AddHerbaria(h ...*Herbarium) *CollectionCreate {
	ids := make([]int, len(h))
	for i := range h {
		ids[i] = h[i].ID
	}
...
func (cc *CollectionCreate) createSpec() (*Collection, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.DendrochronologyIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
