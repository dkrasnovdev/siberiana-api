...
func HasArtWith(preds ...predicate.Art) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := newArtStep()
...
func HasArtifacts() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasArtifactsWith(preds ...predicate.Artifact) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasBooks() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBooksWith(preds ...predicate.Book) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := newBooksStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasPetroglyphsWith(preds ...predicate.Petroglyph) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasProtectedAreaPictures() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProtectedAreaPicturesWith(preds ...predicate.ProtectedAreaPicture) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasDistricts() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasDistrictsWith(preds ...predicate.District) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasSettlements() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSettlementsWith(preds ...predicate.Settlement) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasLocations() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasLocationsWith(preds ...predicate.Location) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasKnownAsAfter() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasKnownAsAfterWith(preds ...predicate.Region) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
...
func HasKnownAsBefore() predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasKnownAsBeforeWith(preds ...predicate.Region) predicate.Region {
	return predicate.Region(func(s *sql.Selector) {
