...
const (
	...
	HerbariaColumn = "collection_herbaria"
...
func TypeValidator(_type Type) error {
	switch _type {
	case TypeArt, TypeArtifacts, TypeBooks, TypeDendrochronology, TypeHerbaria, TypeProtectedAreaPictures, TypePetroglyphs:
		return nil
	default:
