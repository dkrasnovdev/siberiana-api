...
func SlugIsNil() predicate.ProjectType {
	return predicate.ProjectType(sql.FieldIsNull(FieldSlug))
}

// SlugNotNil applies the NotNil predicate on the "slug" field.
func SlugNotNil() predicate.ProjectType {
	return predicate.ProjectType(sql.FieldNotNull(FieldSlug))
}
