...
const (
	// Label holds the string label denoting the ethnos type in the database.
	Label = "ethnos"
	...
	// Table holds the table name of the ethnos in the database.
	Table = "ethnos"
	...
	ArtifactsColumn = "ethnos_artifacts"
)

// Columns holds all SQL columns for ethnos fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the Ethnos queries.
